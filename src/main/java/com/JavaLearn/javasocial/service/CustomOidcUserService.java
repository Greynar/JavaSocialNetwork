...
import com.JavaLearn.javasocial.dto.GoogleUserInfo;
...
public class CustomOidcUserService extends OidcUserService {
    ...
    private OidcUser processOidcUser(OidcUserRequest userRequest, OidcUser oidcUser) {
        ...
        Optional<User> userOptional = userDetailsRepository.findByEmail(googleUserInfo.getEmail());
        if (userOptional.isEmpty()) {
            ...
            user.setUserPicture(googleUserInfo.getPicture());
